...
function(beman_cmake_config_fixup)
    ...
    if(DEFINED arg_UNPARSED_ARGUMENTS)
        message(FATAL_ERROR "beman_cmake_config_fixup was passed extra arguments: ${arg_UNPARSED_ARGUMENTS}")
    endif()
...
[[get_filename_component(PACKAGE_PREFIX_DIR "${CMAKE_CURRENT_LIST_DIR}/../../" ABSOLUTE)]]
        ...
        elseif(NOT EXISTS "${debug_cmake}")
            ...
            while(remainder)
                z_beman_cmake_config_fixup_match_command("${remainder}" "set_target_properties(" matched_command remainder)
                ...
                z_beman_cmake_config_fixup_match_command("${debug_contents}" "set_target_properties(${target} " debug_command unused)
                ...
                z_beman_cmake_config_fixup_merge(merged_libs release_libs debug_libs)
...
function(z_beman_cmake_config_fixup_match_command haystack needle out_match out_remainder)
    set(match "")
    set(remainder "")
...
function(z_beman_cmake_config_fixup_merge out_var release_var debug_var)
