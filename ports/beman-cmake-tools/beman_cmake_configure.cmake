...
macro(z_beman_cmake_configure_both_set_or_unset var1 var2)
...
function(beman_cmake_configure)
    ...
    z_beman_cmake_configure_both_set_or_unset(VCPKG_CXX_FLAGS_DEBUG VCPKG_C_FLAGS_DEBUG)
    z_beman_cmake_configure_both_set_or_unset(VCPKG_CXX_FLAGS_RELEASE VCPKG_C_FLAGS_RELEASE)
    z_beman_cmake_configure_both_set_or_unset(VCPKG_CXX_FLAGS VCPKG_C_FLAGS)
    ...
    ${all_unused_variables}
Please recheck them and remove the unnecessary options from the `beman_cmake_configure` call.
